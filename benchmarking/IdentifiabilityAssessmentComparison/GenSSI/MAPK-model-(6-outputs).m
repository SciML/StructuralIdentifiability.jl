function model = SMTH()
syms KS01 FS10 S11 S00 S10 F KS00 S01 KS10 FS01 FS11 K
...
syms KS010 FS100 S110 S000 S100 F0 KS000 S010 KS100 FS010 FS110 K0
model.sym.p = [c0001; a10; gamma1000; alpha10; b00; beta11; c0111; beta10; alpha11; beta01; alpha01; gamma1100; c0011; c0010; b10; gamma1101; a00; b01; c1011; a01; gamma1110; gamma0100; KS010; FS100; S110; S000; S100; F0; KS000; S010; KS100; FS010; FS110; K0];
model.sym.x = [KS01; FS10; S11; S00; S10; F; KS00; S01; KS10; FS01; FS11; K];
model.sym.g = [];
model.sym.x0 = [KS010; FS100; S110; S000; S100; F0; KS000; S010; KS100; FS010; FS110; K0];
