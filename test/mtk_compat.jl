@testset "Check identifiability of `ODESystem` object" begin
    ...
    correct = Dict(a01 => :nonidentifiable, a21 => :nonidentifiable,
                   a12 => :nonidentifiable)
    ...
    correct = Dict(a12 => :nonidentifiable, a01 + a12 + a21 => :globally,
                   a01 * a12 => :globally, a21 => :nonidentifiable, a01 => :nonidentifiable)
    ...
    @test isequal(correct,
                  assess_local_identifiability(de;
                                               measured_quantities = measured_quantities,
                                               funcs_to_check = funcs_to_check))
    ...
    funcs_to_check = [a01, a21, a12, a01 * a12, a01 + a12 + a21]
    correct = Dict(a01 => :nonidentifiable, a21 => :nonidentifiable,
                   a12 => :nonidentifiable, a01 * a12 => :globally,
                   a01 + a12 + a21 => :globally)
    @test_throws ArgumentError assess_identifiability(de;
                                                      measured_quantities = measured_quantities,
                                                      funcs_to_check = funcs_to_check)
    # ----------
    @parameters a b c
