...
function set_parameter_values(ode::ODE{P},
                              param_values::Dict{P,T}) where {T<:FieldElem,P<:MPolyElem{T}}
...
macro ODEmodel(ex::Expr...)
    ...
    y_dict = gensym()
    y_vars = Set()
    x_dict_create_expr = :($x_dict = Dict{StructuralIdentifiability.Nemo.fmpq_mpoly,
                                          Union{StructuralIdentifiability.Nemo.fmpq_mpoly,
                                                StructuralIdentifiability.AbstractAlgebra.Generic.Frac{StructuralIdentifiability.Nemo.fmpq_mpoly}}}())
    y_dict_create_expr = :($y_dict = Dict{StructuralIdentifiability.Nemo.fmpq_mpoly,
                                          Union{StructuralIdentifiability.Nemo.fmpq_mpoly,
                                                StructuralIdentifiability.AbstractAlgebra.Generic.Frac{StructuralIdentifiability.Nemo.fmpq_mpoly}}}())
    eqs_expr = []
    for eq in equations
...
function PreprocessODE(de::ModelingToolkit.ODESystem,
    ...
    state_eqn_dict = Dict{StructuralIdentifiability.Nemo.fmpq_mpoly,
                          Union{StructuralIdentifiability.Nemo.fmpq_mpoly,
                                StructuralIdentifiability.Nemo.Generic.Frac{StructuralIdentifiability.Nemo.fmpq_mpoly}}}()
