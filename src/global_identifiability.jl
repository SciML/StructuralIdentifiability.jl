...
function check_field_membership(generators::Array{<:Array{<:MPolyElem, 1}, 1},
    ...
    eqs = Array{Any, 1}()
    ring_ext, vars_ext = Nemo.PolynomialRing(Nemo.QQ,
...
function check_identifiability(io_equation::P, parameters::Array{P, 1}, known::Array{P, 1},
                               p::Float64 = 0.99) where {P <: MPolyElem{fmpq}}
...
function assess_global_identifiability(ode::ODE{P},
                                       ...
                                       p::Float64 = 0.99;
                                       var_change = :default) where {P <: MPolyElem{fmpq}}
    result_list = assess_global_identifiability(ode, ode.parameters, known, p;
